...
public class FbxIteratorSrcBase : global::System.IDisposable {
  ...
  public FbxIteratorSrcBase(FbxProperty pProperty, SWIGTYPE_p_FbxClassId pClassId) : this(fbx_wrapperPINVOKE.new_FbxIteratorSrcBase__SWIG_0(FbxProperty.getCPtr(pProperty), SWIGTYPE_p_FbxClassId.getCPtr(pClassId)), true) {
    if (fbx_wrapperPINVOKE.SWIGPendingException.Pending) throw fbx_wrapperPINVOKE.SWIGPendingException.Retrieve();
  }

  public FbxIteratorSrcBase(FbxObject pObject, SWIGTYPE_p_FbxClassId pClassId) : this(fbx_wrapperPINVOKE.new_FbxIteratorSrcBase__SWIG_1(FbxObject.getCPtr(pObject), SWIGTYPE_p_FbxClassId.getCPtr(pClassId)), true) {
    if (fbx_wrapperPINVOKE.SWIGPendingException.Pending) throw fbx_wrapperPINVOKE.SWIGPendingException.Retrieve();
  }
